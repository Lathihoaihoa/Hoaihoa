<section class="mod-content-multi-item mt-81 mb-24 xl:mb-0 2xl:mb-9">
    <div class="container">
        <div class="mx-auto max-w-578 xl:max-w-880 2xl:max-w-1210 2k:max-w-1226">
            <div class="row w-full pl-15">
                <div class="col multi-item-first-col mb-37 xl:mb-24 2xl:w-2/5 2xl:pl-8 2k:pl-4">
                ...
                <div class="col multi-item-second-col w-full 2xl:w-3/5">
                    <div class="row 2xl:pl-21 2k:pl-17">
                        ...
                        <div class="col col-item3 mb-18 ml-1 xl:w-1/2 xl:max-w-402 
                        xl:mt-20 xl:mr-11 xl:ml-0 2xl:max-w-298 2xl:mr-31">
                            <h5>
                        ...
                        <div class="col col-item4 ml-1 xl:w-1/2 xl:max-w-414 xl:mt-20
                        2xl:max-w-304 2xl:mt-20">
                            <h5>
